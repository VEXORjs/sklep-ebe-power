 ...
 *     i działa we wszystkich przeglądarkach (zwykły `feGaussianBlur`
 *     na przezroczystości jest obsługiwany wszerz i wzdłuż).
        ...
        >
            <defs>
                ...
                {/* Miękkie zaniknięcie w tło (fade out) — rozmycie SAMEGO
                    ...
                    Cały filtr jest POZA <mask>, więc nie uderza w bugi Safari
                    dotyczące filtrowania wewnątrz maski. */}
                <filter
            ...
            {/* Kadr: karta + zdjęcie wycięte maską, następnie rozmyte
                na krawędziach (feather filter aplikowany PO maskowaniu). */}
                ...
                {src ? (
                    <image
                        ...
                        /* Zdjęcie ma wyraźny margines do brzegu maski (70 px po
                           ...
                           soft-blur nie zjada krawędzi produktu, a jedynie
                           wtapia kartę w tło sekcji. */
                        x="70"
                        y="52"
                        width="460"
                        height="345"
