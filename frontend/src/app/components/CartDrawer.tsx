                ...
                {items.length === 0 ? (
                    <div className="flex flex-1 flex-col items-center justify-center gap-4 px-6 text-center">
                        ...
                        <a
                            href="/#produkty"
                            onClick={closeCart}
                            className="mt-2 rounded-md bg-amber-500 px-5 py-2.5 text-sm font-bold text-slate-950 transition-colors hover:bg-amber-400"
                        >
                            Przeglądaj ofertę
                        </a>
                    </div>
                        ...
                        <div className="border-t border-neutral-800 px-6 py-5">
                            ...
                            <div className="flex flex-col gap-2">
                                <Link
                                    href="/checkout"
                                    onClick={closeCart}
                                    className="rounded-md bg-amber-500 px-5 py-3 text-center text-sm font-bold text-slate-950 transition-colors hover:bg-amber-400"
                                >
                                    Przejdź do kasy ⚡
                                </Link>
                                <Link
                                    href="/cart"
                                    onClick={closeCart}
                                    className="rounded-md border border-neutral-700 px-5 py-3 text-center text-sm font-semibold text-white transition-colors hover:border-amber-500/60 hover:text-amber-300"
                                >
