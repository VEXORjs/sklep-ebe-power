...
export default function ContactBanner() {
    return (
        <div className="w-full max-w-7xl mx-auto p-4 grid grid-cols-1 lg:grid-cols-3 gap-4">
            ...
            <div className="lg:col-span-2 rounded-lg bg-gradient-to-r from-teal-700 via-teal-950 to-slate-950 p-6 md:p-8 flex flex-col justify-between gap-6 shadow-lg">
