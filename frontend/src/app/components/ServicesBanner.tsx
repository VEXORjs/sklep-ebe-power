        ...
        <section className="w-full max-w-7xl mx-auto p-4">
            ...
            <span className="text-xs font-bold uppercase tracking-wider text-neutral-400">
              Usługi wynajmu
                        ...
                        <h3 className="text-xl font-bold text-white leading-snug">
                            Rozwiązania w zakresie <span className="text-amber-400">wynajmu</span> agregatów i osprzętu
                        </h3>
                    ...
                    <Link
                        href="/wynajem"
                        className="inline-block text-center px-4 py-2.5 text-xs font-semibold text-white bg-amber-600 hover:bg-amber-500 rounded transition-colors"
                    >
            ...
            <span className="text-xs font-bold uppercase tracking-wider text-neutral-400">
              Konserwacja i serwis
                        ...
                        <h3 className="text-xl font-bold text-white leading-snug">
                            Nasze <span className="text-amber-400">doświadczenie</span> do Twojej dyspozycji
                        </h3>
                        <p className="text-xs md:text-sm text-neutral-400 leading-relaxed">
                ...
                <div className="relative bg-[#141618] border border-amber-500 rounded-lg p-6 md:p-8 flex flex-col justify-between space-y-6 overflow-hidden shadow-lg shadow-amber-950/30">

                    {/* 🏷️ Wstążka w prawym górnym rogu */}
                    <div className="absolute top-0 right-0 w-28 h-28 overflow-hidden pointer-events-none">
                        <div className="absolute transform rotate-45 bg-amber-400 text-slate-950 text-[9px] font-extrabold py-1 right-[-35px] top-[24px] w-[140px] text-center shadow-md flex items-center justify-center gap-1">
                            <span>🎧 KONTAKT</span>
                        </div>
                    </div>
                    ...
                    <a
                        ...
                        target="_blank"
                        className="inline-block text-center px-4 py-2.5 text-xs font-semibold text-amber-400 border border-amber-500/60 hover:bg-amber-500/10 rounded transition-colors"
